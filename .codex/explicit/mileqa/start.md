...
- **CLEAN (exit 0)** — a full-roster round surfaces nothing above **medium** *in-scope* after verification (out-of-scope findings are reported, not blocking). The roster signs it off — never your own say-so; your own tests are necessary but not sufficient. Milestone gate opens.
