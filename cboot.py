...
def assemble_settings(report):
    ...
    settings = {
        ...
        "customInstructions": (
            "BEFORE RESPONDING TO ANY MESSAGE: Read .codex/start.md then .state/start.md. "
            "These contain your operating rules. Do not skip this step regardless of what the user asks first."
        ),
    }
    ...
    settings["hooks"] = {
        "SessionStart": [{
            "matcher": "",
            "hooks": [
                {"type": "command", "command": hook_cmd("boot-inject.sh")},
