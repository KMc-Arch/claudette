...
| claude-md-immutability-guard.sh | CM01-CM06 | Blocks body and protected-key changes to any CLAUDE.md; blocks creating one; allows agent-editable keys and other files (full matrix + mutation proof: `hooks/tests/test_claude_md_guard.sh`, `mutate_claude_md_guard.sh`) |
